...
<head>
    ...
    <link rel="icon" href="#">
    <title>Home || Easy Ordering & Complete Restaurant Guide - Web Pirates</title>
...
<body style="font-family: 'Pangolin', cursive;" class="home">
    ...
    <section class="hero bg-image" data-image-src="images/index.jpg">
        <div class="hero-inner">
            <div class="container text-center hero-text font-white">
                <h1>Online ordering, pickup, and delivery</h1>
                ...
                <div class="steps">
                    ...
                    <div class="step-item step3">
                        ...
                        <h4><span style="color:white;">3. </span>Pickup and Delivery</h4>
                    </div>
    ...
    <section class="popular">
        <div class="container">
            <div class="title text-xs-center m-b-30">
                <h2>Popular Dishes available</h2>
                <p class="lead">The simplest method to order your favorite cuisine from these top options</p>
            </div>
            <div class="row">
...
<div id="info">
    <h2 style="color:white; line-height:3; font-weight: 600;"> About Us</h2>
    <p style="color: white;"> 
Welcome to FoodMania, your gateway to a world of culinary delights delivered straight to your doorstep. Founded with a passion for good food and convenience, we're on a mission to redefine your dining experience. At [Your Company Name], we curate a diverse menu featuring local favorites and global cuisines, ensuring a feast for every palate. Our commitment to freshness, innovation, and exceptional service sets us apart. Join us on a flavorful journey, where technology meets taste, and every order is a celebration of great food. Your satisfaction is our priority, making FoodMania the ultimate destination for a seamless and delectable dining adventure. </p>
</div>
<img src="https://images.unsplash.com/photo-1563245372-f21724e3856d?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1129&q=80" alt="image of the inside of a japanese restaurant" class="img5" >


<style>
    @import url('https://fonts.googleapis.com/css2?family=Pangolin&family=Rock+Salt&display=swap');
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="title-block pull-left">
                        <h4>Highlighted Dining Establishments</h4>
                    </div>
                </div>
                <div class="col-sm-8">
